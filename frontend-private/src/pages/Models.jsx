...
const Models = () => {
  ...
  const fetchModels = async () => {
    setLoading(true);
    try {
      const response = await fetch("https://actividad-evaluada-15porciento-1.onrender.com/api/models");
  ...
  const deleteModel = async (id) => {
    try {
      const response = await fetch(`https://actividad-evaluada-15porciento-1.onrender.com/api/models/${id}`, {
        method: "DELETE",
      });
